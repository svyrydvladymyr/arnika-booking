...
if ($outp != []){
    $stmts = $conn->prepare("SELECT last_name, first_name, nomer_kimn, telephone, kilk_dniv, tip, status FROM bookinggurt2 WHERE data_zaizdu = ? AND (status = 'rezerv' OR status = 'pay') ORDER BY nomer_kimn");
